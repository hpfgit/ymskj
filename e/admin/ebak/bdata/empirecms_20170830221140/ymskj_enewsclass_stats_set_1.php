...
E_D("DROP TABLE IF EXISTS `ymskj_enewsclass_stats_set`;");
E_C("CREATE TABLE `ymskj_enewsclass_stats_set` (
...
E_D("replace into `ymskj_enewsclass_stats_set` values('1','3600','0','20130717');");
